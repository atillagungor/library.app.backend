...
public class UserOperationClaimManager : IUserOperationClaimService
{
    ...
    UserOperationClaimBusinessRules _userOperationClaimBusinessRule;
    public UserOperationClaimManager(IMapper mapper, IUserOperationClaimDal userOperationClaimDal, UserOperationClaimBusinessRules userOperationClaimBusinessRule)
    {
        _mapper = mapper;
    ...
    {
        await
            _userOperationClaimBusinessRule.CheckIfAlreadyExistsWithForeignKey(createUserOperationClaimRequest.UserId,
    ...
    {
        UserOperationClaim userOperationClaim = await _userOperationClaimBusinessRule.CheckIfExistsWithForeignKey(deleteUserOperationClaimRequest.UserId, deleteUserOperationClaimRequest.OperationClaimId);
