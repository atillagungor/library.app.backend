...
namespace Business.Concretes
{
    public class AdminManager : IAdminService
    {
        ...
        private readonly AdminBusinessRule _adminBusinessRules;
        private readonly IMapper _mapper;

        public AdminManager(IAdminDal adminDal, AdminBusinessRule adminBusinessRules, IMapper mapper)
        {
            _adminDal = adminDal;
        ...
        {
            await _adminBusinessRules.CheckIfEmailIsUniqueAsync(createAdminRequest.Email);
        ...
        {
            await _adminBusinessRules.ValidateAdminForUpdateAsync(updateAdminRequest.Id, updateAdminRequest.Email);
