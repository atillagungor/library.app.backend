...
public class OperationClaimManager : IOperationClaimService
{
    ...
    OperationClaimBusinessRules _operationClaimBusinessRule;
    IUserOperationClaimService _userOperationClaimService;

    public OperationClaimManager(IMapper mapper, IOperationClaimDal operationClaimDal, OperationClaimBusinessRules operationClaimBusinessRule, IUserOperationClaimService userOperationClaimService)
    {
        _mapper = mapper;
    ...
    {
        OperationClaim operationClaim = await _operationClaimBusinessRule.CheckIfExistsById(deleteOperationClaimRequest.Id);
    ...
    {
        OperationClaim operationClaim = await _operationClaimBusinessRule.CheckIfExistsById(updateOperationClaimRequest.Id);
