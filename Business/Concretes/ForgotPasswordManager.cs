...
public class ForgotPasswordManager : IForgotPasswordService
{
    ...
    ForgotPasswordBusinessRule _forgotPasswordBusinessRules;
    public ForgotPasswordManager(IMapper mapper, IForgotPasswordDal forgotPasswordDal, ForgotPasswordBusinessRule forgotPasswordBusinessRules)
    {
